...
(function(){function e(a,b){console.log("ten."+a+"(): "+b);return!1}function f(a,b,c){var d=a.classList;if(ten.isArray(b))ten.each(b,function(a,b){d[c](b)});else if(ten.isString(b))d[c](b);return a}function g(a,b,c){ten.isString(b)&&(b=[b]);if(ten.isArray(b))for(var d=0;d<b.length;d++)a.innerHTML="append"==c?a.innerHTML+b[d]:"prepend"==c&&b[d]+a.innerHTML;else e(c,"invalid parameters");return a}ten={version:"0.0.3",ajax:function(a){var b={url:!1,type:"GET",data:!1,dataType:"json",success:!1,error:!1,
